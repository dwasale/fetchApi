// let htmlLsit = document.querySelector('ol');
// alert("The list of item on this page were added using javaScript!! :) ");
// for (i =0; i < 5; i++){
//     let listItem = document.createElement('li');
//     listItem.innerHTML = "I am a list item: " + i;
//     htmlLsit.appendChild(listItem);
// }
